...
NIGHTLY_TESTS = {
    ...
    "~/ray/release/nightly_tests/nightly_tests.yaml": [
        ReleaseTest("shuffle_10gb", retry=4),
        ReleaseTest("shuffle_50gb", retry=4),
        ReleaseTest("shuffle_50gb_large_partition", retry=4),
        ReleaseTest("shuffle_100gb", retry=4),
        ReleaseTest("non_streaming_shuffle_100gb", retry=4),
        ReleaseTest("non_streaming_shuffle_50gb_large_partition", retry=4),
        ReleaseTest("non_streaming_shuffle_50gb", retry=4),
        ReleaseTest("dask_on_ray_10gb_sort", retry=4),
        ReleaseTest("dask_on_ray_100gb_sort", retry=4),
        ReleaseTest("shuffle_1tb_large_partition", retry=4),
        ReleaseTest("dask_on_ray_large_scale_test_no_spilling", retry=4),
        ReleaseTest("dask_on_ray_large_scale_test_spilling", retry=4),
        ReleaseTest("stress_test_placement_group", retry=4),
    ],
